...
private val PremiumBlackColorScheme get() = darkColorScheme(
    ...
    onPrimary     = PremiumBlackColors.Background, // primary is white → on-color is black
    onSecondary   = PremiumBlackColors.Background,
...
private val PremiumWhiteColorScheme get() = lightColorScheme(
    ...
    onPrimary     = PremiumWhiteColors.Background, // primary is black → on-color is white
    onSecondary   = PremiumWhiteColors.Background,
