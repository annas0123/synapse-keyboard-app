...
val EmeraldGreen: Color get() = ThemeManager.currentTheme.secondary
val CrispWhite = Color(0xFFFFFFFF)
val MutedGrey: Color get() = ThemeManager.currentTheme.muted
// GlassmorphismColor = theme surface so cards ALWAYS match the selected theme
val GlassmorphismColor: Color get() = ThemeManager.currentTheme.surface
val TextColor: Color get() = if (ThemeManager.currentTheme.isDark) Color.White else Color(0xFF0F172A)
